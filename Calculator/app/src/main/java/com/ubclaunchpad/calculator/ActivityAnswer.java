...
public class ActivityAnswer extends AppCompatActivity implements View.OnClickListener{
    private final static String TAG = ActivityAnswer.class.getSimpleName();
